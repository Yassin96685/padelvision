...
const ERROR_POOL_BY_LOCALE: Record<LocaleCode, Omit<ErrorEntry, 'id'>[]> = {
  ...
  de: [
    { time: '08:15', shot: 'Rückhand-Slice', zone: 'Netzbereich', cause: 'Technik', severity: 'high', explanation: 'Handgelenk zu steif beim Durchschwingen. Ball streifte das Netz wegen zu flachem Schlägerkopfwinkel.', tip: 'Schlägerfläche beim Rückhand-Slice am Netz 10° mehr öffnen.' },
    ...
    { time: '35:10', shot: 'Smash', zone: 'Netzbereich', cause: 'Entscheidungsfindung', severity: 'medium', explanation: 'Flugkurve nach Glas-Abpraller falsch eingeschätzt. Gehetzter Schlag führte zu dezentralem Treffen.', tip: 'Ball nach dem Glas-Abpraller tiefer fallen lassen, bevor du angreifst.' },
